...
!function (t) {
    ...
    t.cleanData = function (e) {
        ...
        }), a.prototype = t.widget.extend(r, {widgetEventPrefix: o && r.widgetEventPrefix || e}, h, {
            constructor: a,
            namespace: l,
            widgetName: e,
            widgetFullName: n
        ...
        for (var i, s, n = h.call(arguments, 1), o = 0, a = n.length; o < a; o++) for (i in n[o]) s = n[o][i], n[o].hasOwnProperty(i) && void 0 !== s && (t.isPlainObject(s) ? e[i] = t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s) : e[i] = s);
        return e
    ...
    !function () {
        t.ui = t.ui || {};
        var e, i, s = Math.max, n = Math.abs, o = Math.round, a = /left|center|right/, r = /top|center|bottom/,
        ...
        t.position = {
            ...
            e = t.extend({}, e);
            var c, f, m, g, v, _, b, y, w = t(e.of), x = t.position.getWithinInfo(e.within),
                k = t.position.getScrollInfo(x), C = (e.collision || "flip").split(" "), D = {};
            return _ = 9 === (y = (b = w)[0]).nodeType ? {
                ...
                var a, r, h = t(this), l = h.outerWidth(), u = h.outerHeight(), _ = p(this, "marginLeft"),
                    b = p(this, "marginTop"), y = l + _ + p(this, "marginRight") + k.width,
                    I = u + b + p(this, "marginBottom") + k.height, T = t.extend({}, v),
                ...
                "right" === e.my[0] ? T.left -= l : "center" === e.my[0] && (T.left -= l / 2), "bottom" === e.my[1] ? T.top -= u : "center" === e.my[1] && (T.top -= u / 2), T.left += P[0], T.top += P[1], i || (T.left = o(T.left), T.top = o(T.top)), a = {
                    ...
                    var i = g.left - T.left, o = i + f - l, a = g.top - T.top, r = a + m - u, c = {
                        target: {element: w, left: g.left, top: g.top, width: f, height: m},
                        element: {element: h, left: T.left, top: T.top, width: l, height: u},
            ...
            var e, s, n, o, a, r = document.getElementsByTagName("body")[0], h = document.createElement("div");
            for (a in e = document.createElement(r ? "div" : "body"), n = {
                ...
                margin: 0,
                background: "none"
            }, r && t.extend(n, {position: "absolute", left: "-1000px", top: "-1000px"}), n) e.style[a] = n[a];
    ...
    t.extend(t.ui, {datepicker: {version: "1.11.4"}}), t.extend(g.prototype, {
    ...
    t.effects = {effect: {}}, function (t, e) {
        ...
        t.extend(t.effects, {
            ...
            effect: function () {
                var i = e.apply(this, arguments), s = i.mode, n = i.queue, o = t.effects.effect[i.effect];
                if (t.fx.off || !o) return s ? this[s](i.duration, i.complete) : this.each(function () {
                    i.complete && i.complete.call(this)
                });

                function a(e) {
                    var s = t(this), n = i.complete, a = i.mode;
    ...
    t.effects, t.effects.effect.blind = function (e, i) {
        var s, n, o, a = t(this), r = ["position", "top", "bottom", "left", "right", "height", "width"],
            h = t.effects.setMode(a, e.mode || "hide"), l = e.direction || "up", c = /up|down|vertical/.test(l),
            u = c ? "height" : "width", d = c ? "top" : "left", p = /up|left|vertical|horizontal/.test(l), f = {},
            m = "show" === h;
        a.parent().is(".ui-effects-wrapper") ? t.effects.save(a.parent(), r) : t.effects.save(a, r), a.show(), n = (s = t.effects.createWrapper(a).css({overflow: "hidden"}))[u](), o = parseFloat(s.css(d)) || 0, f[u] = m ? n : 0, p || (a.css(c ? "bottom" : "right", 0).css(c ? "top" : "left", "auto").css({position: "absolute"}), f[d] = m ? o : n + o), m && (s.css(u, 0), p || s.css(d, o + n)), s.animate(f, {
            duration: e.duration,
            easing: e.easing,
            queue: !1,
            complete: function () {
        ...
        var s, n, o, a, r, h, l = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, c = l, u = t(this),
            d = "show" === t.effects.setMode(u, e.mode || "hide"), p = u.show().css("visibility", "hidden").offset(),
            f = Math.ceil(u.outerWidth() / c), m = Math.ceil(u.outerHeight() / l), g = [];
        ...
        for (s = 0; s < l; s++) for (a = p.top + s * m, h = s - (l - 1) / 2, n = 0; n < c; n++) o = p.left + n * f, r = n - (c - 1) / 2, u.clone().appendTo("body").wrap("<div></div>").css({
            position: "absolute",
            visibility: "visible",
            left: -n * f,
            top: -s * m
        ...
        var s, n, o, a = t(this),
            ...
            h = ["width", "height", "overflow"], l = ["fontSize"],
            c = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
            u = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
            d = t.effects.setMode(a, e.mode || "effect"), p = e.restore || "effect" !== d, f = e.scale || "both",
            m = e.origin || ["middle", "center"], g = a.css("position"),
        ...
        "show" === d && a.show(), s = {
            ...
            var i = t(this), s = i.height(), n = i.width(), a = i.outerHeight(), r = i.outerWidth();
        ...
        var s = t(this), n = t.extend(!0, {}, e), o = t.effects.setMode(s, e.mode || "effect"),
            ...
            c = "horizontal" !== r ? a / 100 : 1, u = "vertical" !== r ? a / 100 : 1;
    ...
    t.widget("ui.spinner", {
        ...
        _isLocal: (k = /#.*$/, function (t) {
            var e, i;
            e = (t = t.cloneNode(!1)).href.replace(k, ""), i = location.href.replace(k, "");
            try {
...
function iOSVersion() {
    ...
    return (t.indexOf("iPhone") > -1 || t.indexOf("iPad") > -1) && o > -1 ? window.Number(t.substr(o + 3, 3).replace("_", ".")) : 0
}
...
!function (t) {
    var o = {
        init: function (o) {
            o = t.extend(!0, {
                ...
                mouseWheelPixels: 60,
                autoDraggerLength: !0,
                scrollButtons: {enable: !1, scrollType: "continuous", scrollSpeed: 20, scrollAmount: 40},
                advanced: {
                ...
                callbacks: {
                    ...
                    }, onTotalScrollOffset: 0, whileScrolling: !1, whileScrollingInterval: 30
                }
            }, o);
            return t(document).data("mCS-is-touch-device", !1), "ontouchstart" in window && t(document).data("mCS-is-touch-device", !0), this.each(function () {
                var a = t(this);
                if (o.set_width && a.css("width", o.set_width), o.set_height && a.css("height", o.set_height), t(document).data("mCustomScrollbar-index")) {
                    var l = parseInt(t(document).data("mCustomScrollbar-index"));
                    t(document).data("mCustomScrollbar-index", l + 1)
                } else t(document).data("mCustomScrollbar-index", "1");
                a.wrapInner("<div class='mCustomScrollBox' id='mCSB_" + t(document).data("mCustomScrollbar-index") + "' style='position:relative; height:100%; overflow:hidden; max-width:100%;' />").addClass("mCustomScrollbar _mCS_" + t(document).data("mCustomScrollbar-index"));
                var e = a.children(".mCustomScrollBox");
                if (o.horizontalScroll) {
                    ...
                    var n = e.children(".mCSB_h_wrapper");
                ...
                var r = e.children(".mCSB_container");
                ...
                var i, s = e.children(".mCSB_scrollTools"),
                    c = s.children(".mCSB_draggerContainer").children(".mCSB_dragger");
                (o.horizontalScroll ? c.data("minDraggerWidth", c.width()) : c.data("minDraggerHeight", c.height()), o.scrollButtons.enable && (o.horizontalScroll ? s.prepend("<a class='mCSB_buttonLeft' style='display:block; position:relative;'></a>").append("<a class='mCSB_buttonRight' style='display:block; position:relative;'></a>") : s.prepend("<a class='mCSB_buttonUp' style='display:block; position:relative;'></a>").append("<a class='mCSB_buttonDown' style='display:block; position:relative;'></a>")), e.bind("scroll", function () {
                    a.is(".mCS_disabled") || e.scrollTop(0).scrollLeft(0)
                }), a.data({
                    mCS_Init: !0,
                    horizontalScroll: o.horizontalScroll,
                    scrollInertia: o.scrollInertia,
                    scrollEasing: o.scrollEasing,
                    ...
                    whileScrolling_Interval: o.callbacks.whileScrollingInterval,
                    ...
                    whileScrolling: !1
                }).mCustomScrollbar("update"), o.horizontalScroll ? "none" !== a.css("max-width") && (o.advanced.updateOnContentResize || (o.advanced.updateOnContentResize = !0), a.data({
                    mCS_maxWidth: parseInt(a.css("max-width")),
                    mCS_maxWidth_Interval: setInterval(function () {
                        r.outerWidth() > a.data("mCS_maxWidth") && (clearInterval(a.data("mCS_maxWidth_Interval")), a.mCustomScrollbar("update"))
                    }, 150)
                })) : "none" !== a.css("max-height") && a.data({
                    mCS_maxHeight: parseInt(a.css("max-height")),
                    mCS_maxHeight_Interval: setInterval(function () {
                        e.css("max-height", a.data("mCS_maxHeight")), r.outerHeight() > a.data("mCS_maxHeight") && (clearInterval(a.data("mCS_maxHeight_Interval")), a.mCustomScrollbar("update"))
                    }, 150)
                }), o.advanced.updateOnBrowserResize) && t(window).resize(function () {
                    i && clearTimeout(i), i = setTimeout(function () {
                        a.is(".mCS_disabled") || a.is(".mCS_destroyed") || a.mCustomScrollbar("update")
                    }, 150)
                });
                if (o.advanced.updateOnContentResize) {
                    if (o.horizontalScroll) var d = r.outerWidth(); else d = r.outerHeight();
                    setInterval(function () {
                        if (o.horizontalScroll) {
                            ...
                            var t = r.outerWidth()
                        } else t = r.outerHeight();
                        t != d && (a.mCustomScrollbar("update"), d = t)
                    }, 300)
                }
            })
        }, update: function () {
            var o = t(this), a = o.children(".mCustomScrollBox"), l = a.children(".mCSB_container");
            l.removeClass("mCS_no_scrollbar"), o.removeClass("mCS_disabled mCS_destroyed"), a.scrollTop(0).scrollLeft(0);
            var e = a.children(".mCSB_scrollTools"), n = e.children(".mCSB_draggerContainer"),
                r = n.children(".mCSB_dragger");
            if (o.data("horizontalScroll")) {
                var i = e.children(".mCSB_buttonLeft"), s = e.children(".mCSB_buttonRight"), c = a.width();
                o.data("autoExpandHorizontalScroll") && l.css({
                    position: "absolute",
                    width: "auto"
                }).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({
                    width: l.outerWidth(),
                ...
                var d = l.outerWidth()
            } else var u = e.children(".mCSB_buttonUp"), h = e.children(".mCSB_buttonDown"), m = a.height(),
                S = l.outerHeight();
            if (S > m && !o.data("horizontalScroll")) {
                e.css("display", "block");
                var p = n.height();
                if (o.data("autoDraggerLength")) {
                    var b = Math.round(m / S * p), f = r.data("minDraggerHeight");
                    if (b <= f) r.css({height: f}); else if (b >= p - 10) {
                        var g = p - 10;
                        r.css({height: g})
                    } else r.css({height: b});
                    r.children(".mCSB_dragger_bar").css({"line-height": r.height() + "px"})
                }
                var v = (S - m) / (p - r.height());
                o.data("scrollAmount", v).mCustomScrollbar("scrolling", a, l, n, r, u, h, i, s);
                var _ = Math.abs(Math.round(l.position().top));
                o.mCustomScrollbar("scrollTo", _, {callback: !1})
            } else if (d > c && o.data("horizontalScroll")) {
                e.css("display", "block");
                var C = n.width();
                if (o.data("autoDraggerLength")) {
                    var w = Math.round(c / d * C), B = r.data("minDraggerWidth");
                    if (w <= B) r.css({width: B}); else if (w >= C - 10) {
                        var x = C - 10;
                        r.css({width: x})
                    } else r.css({width: w})
                }
                v = (d - c) / (C - r.width());
                o.data("scrollAmount", v).mCustomScrollbar("scrolling", a, l, n, r, u, h, i, s);
                _ = Math.abs(Math.round(l.position().left));
                o.mCustomScrollbar("scrollTo", _, {callback: !1})
            } else a.unbind("mousewheel focusin"), o.data("horizontalScroll") ? r.add(l).css("left", 0) : r.add(l).css("top", 0), e.css("display", "none"), l.addClass("mCS_no_scrollbar"), o.data({
                bindEvent_mousewheel: !1,
                bindEvent_focusin: !1
            })
        }, scrolling: function (o, a, l, e, n, r, i, s) {
            var c, d = t(this);
            if (d.mCustomScrollbar("callbacks", "whileScrolling"), !e.hasClass("ui-draggable")) {
                if (d.data("horizontalScroll")) var u = "x"; else u = "y";
                e.draggable({
                    axis: u, containment: "parent", drag: function (t, o) {
                        d.mCustomScrollbar("scroll"), e.addClass("mCSB_dragger_onDrag")
                    }, stop: function (t, o) {
                        e.removeClass("mCSB_dragger_onDrag")
                    }
                })
            }
            if (d.data("bindEvent_scrollbar_click") || (l.bind("click", function (t) {
                var o, a;
                d.data("horizontalScroll") ? ((o = t.pageX - l.offset().left) < e.position().left || o > e.position().left + e.width()) && ((a = o) >= l.width() - e.width() && (a = l.width() - e.width()), e.css("left", a), d.mCustomScrollbar("scroll")) : ((o = t.pageY - l.offset().top) < e.position().top || o > e.position().top + e.height()) && ((a = o) >= l.height() - e.height() && (a = l.height() - e.height()), e.css("top", a), d.mCustomScrollbar("scroll"))
            }), d.data({bindEvent_scrollbar_click: !0})), d.data("mouseWheel")) {
                var h = d.data("mouseWheel");
                if ("auto" === d.data("mouseWheel")) {
                    h = 8;
                    var m = navigator.userAgent;
                    -1 != m.indexOf("Mac") && -1 != m.indexOf("Safari") && -1 != m.indexOf("AppleWebKit") && -1 == m.indexOf("Chrome") && (h = 1)
                }
                d.data("bindEvent_mousewheel") || (o.bind("mousewheel", function (t, o) {
                    t.preventDefault();
                    var n = Math.abs(o * h);
                    if (d.data("horizontalScroll")) if ("pixels" === d.data("mouseWheel")) {
                        o = o < 0 ? -1 : 1;
                        var r = Math.abs(Math.round(a.position().left)) - o * d.data("mouseWheelPixels");
                        d.mCustomScrollbar("scrollTo", r)
                    } else {
                        var i = e.position().left - o * n;
                        e.css("left", i), e.position().left < 0 && e.css("left", 0);
                        var s = l.width(), c = e.width();
                        e.position().left > s - c && e.css("left", s - c), d.mCustomScrollbar("scroll")
                    } else if ("pixels" === d.data("mouseWheel")) {
                        o = o < 0 ? -1 : 1;
                        r = Math.abs(Math.round(a.position().top)) - o * d.data("mouseWheelPixels");
                        d.mCustomScrollbar("scrollTo", r)
                    } else {
                        var u = e.position().top - o * n;
                        e.css("top", u), e.position().top < 0 && e.css("top", 0);
                        var m = l.height(), S = e.height();
                        e.position().top > m - S && e.css("top", m - S), d.mCustomScrollbar("scroll")
                    }
                }), d.data({bindEvent_mousewheel: !0}))
            }
            if (d.data("scrollButtons_enable")) if ("pixels" === d.data("scrollButtons_scrollType")) t.browser.msie && parseInt(t.browser.version) < 9 && d.data("scrollInertia", 0), d.data("horizontalScroll") ? (s.add(i).unbind("mousedown touchstart onmsgesturestart mouseup mouseout touchend onmsgestureend", S, p), d.data({bindEvent_buttonsContinuous_x: !1}), d.data("bindEvent_buttonsPixels_x") || (s.bind("click", function (t) {
                t.preventDefault(), a.is(":animated") || (c = Math.abs(a.position().left) + d.data("scrollButtons_scrollAmount"), d.mCustomScrollbar("scrollTo", c))
            }), i.bind("click", function (t) {
                t.preventDefault(), a.is(":animated") || (c = Math.abs(a.position().left) - d.data("scrollButtons_scrollAmount"), a.position().left >= -d.data("scrollButtons_scrollAmount") && (c = "left"), d.mCustomScrollbar("scrollTo", c))
            }), d.data({bindEvent_buttonsPixels_x: !0}))) : (r.add(n).unbind("mousedown touchstart onmsgesturestart mouseup mouseout touchend onmsgestureend", S, p), d.data({bindEvent_buttonsContinuous_y: !1}), d.data("bindEvent_buttonsPixels_y") || (r.bind("click", function (t) {
                t.preventDefault(), a.is(":animated") || (c = Math.abs(a.position().top) + d.data("scrollButtons_scrollAmount"), d.mCustomScrollbar("scrollTo", c))
            }), n.bind("click", function (t) {
                t.preventDefault(), a.is(":animated") || (c = Math.abs(a.position().top) - d.data("scrollButtons_scrollAmount"), a.position().top >= -d.data("scrollButtons_scrollAmount") && (c = "top"), d.mCustomScrollbar("scrollTo", c))
            }), d.data({bindEvent_buttonsPixels_y: !0}))); else if (d.data("horizontalScroll")) {
                if (s.add(i).unbind("click"), d.data({bindEvent_buttonsPixels_x: !1}), !d.data("bindEvent_buttonsContinuous_x")) {
                    s.bind("mousedown touchstart onmsgesturestart", function (t) {
                        t.preventDefault(), t.stopPropagation(), d.data({
                            mCSB_buttonScrollRight: setInterval(function () {
                                var t = Math.round((Math.abs(Math.round(a.position().left)) + d.data("scrollButtons_scrollSpeed")) / d.data("scrollAmount"));
                                d.mCustomScrollbar("scrollTo", t, {moveDragger: !0})
                            }, 30)
                        })
                    });
                    var S = function (t) {
                        t.preventDefault(), t.stopPropagation(), clearInterval(d.data("mCSB_buttonScrollRight"))
                    };
                    s.bind("mouseup touchend onmsgestureend mouseout", S), i.bind("mousedown touchstart onmsgesturestart", function (t) {
                        t.preventDefault(), t.stopPropagation(), d.data({
                    ...
                    var p = function (t) {
                        t.preventDefault(), t.stopPropagation(), clearInterval(d.data("mCSB_buttonScrollLeft"))
                    };
                    i.bind("mouseup touchend onmsgestureend mouseout", p), d.data({bindEvent_buttonsContinuous_x: !0})
                }
            } else if (r.add(n).unbind("click"), d.data({bindEvent_buttonsPixels_y: !1}), !d.data("bindEvent_buttonsContinuous_y")) {
                r.bind("mousedown touchstart onmsgesturestart", function (t) {
                    t.preventDefault(), t.stopPropagation(), d.data({
                        mCSB_buttonScrollDown: setInterval(function () {
                            var t = Math.round((Math.abs(Math.round(a.position().top)) + d.data("scrollButtons_scrollSpeed")) / d.data("scrollAmount"));
                            d.mCustomScrollbar("scrollTo", t, {moveDragger: !0})
                        }, 30)
                    })
                });
                r.bind("mouseup touchend onmsgestureend mouseout", function (t) {
                    t.preventDefault(), t.stopPropagation(), clearInterval(d.data("mCSB_buttonScrollDown"))
                }), n.bind("mousedown touchstart onmsgesturestart", function (t) {
                    t.preventDefault(), t.stopPropagation(), d.data({
                ...
                n.bind("mouseup touchend onmsgestureend mouseout", function (t) {
                    t.preventDefault(), t.stopPropagation(), clearInterval(d.data("mCSB_buttonScrollUp"))
                }), d.data({bindEvent_buttonsContinuous_y: !0})
            }
            if (d.data("autoScrollOnFocus") && (d.data("bindEvent_focusin") || (o.bind("focusin", function () {
                o.scrollTop(0).scrollLeft(0);
                var n = t(document.activeElement);
                if (n.is("input,textarea,select,button,a[tabindex],area,object")) if (d.data("horizontalScroll")) {
                    var r = a.position().left, i = n.position().left, s = o.width(), c = n.outerWidth();
                    if (r + i >= 0 && r + i <= s - c) ; else (u = i / d.data("scrollAmount")) >= l.width() - e.width() && (u = l.width() - e.width()), e.css("left", u), d.mCustomScrollbar("scroll")
                } else {
                    var u, h = a.position().top, m = n.position().top, S = o.height(), p = n.outerHeight();
                    if (h + m >= 0 && h + m <= S - p) ; else (u = m / d.data("scrollAmount")) >= l.height() - e.height() && (u = l.height() - e.height()), e.css("top", u), d.mCustomScrollbar("scroll")
                }
            }), d.data({bindEvent_focusin: !0}))), t(document).data("mCS-is-touch-device")) {
                var b, f, g, v, _, C, w, B, x;
                if (!d.data("bindEvent_scrollbar_touch")) e.bind("touchstart onmsgesturestart", function (o) {
                    o.preventDefault(), o.stopPropagation();
                    var a = o.originalEvent.touches[0] || o.originalEvent.changedTouches[0], l = t(this),
                        e = l.offset(), n = a.pageX - e.left, r = a.pageY - e.top;
                    n < l.width() && n > 0 && r < l.height() && r > 0 && (b = r, f = n)
                }), e.bind("touchmove onmsgesturechange", function (o) {
                    o.preventDefault(), o.stopPropagation();
                    var a = o.originalEvent.touches[0] || o.originalEvent.changedTouches[0], l = t(this).offset(),
                        n = a.pageX - l.left, r = a.pageY - l.top;
                    d.data("horizontalScroll") ? d.mCustomScrollbar("scrollTo", e.position().left - f + n, {moveDragger: !0}) : d.mCustomScrollbar("scrollTo", e.position().top - b + r, {moveDragger: !0})
                }), d.data({bindEvent_scrollbar_touch: !0});
                if (!d.data("bindEvent_content_touch")) a.bind("touchstart onmsgesturestart", function (o) {
                    g = o.originalEvent.touches[0] || o.originalEvent.changedTouches[0], v = t(this), _ = v.offset(), C = g.pageX - _.left, w = g.pageY - _.top, B = w, x = C
                }), a.bind("touchmove onmsgesturechange", function (o) {
                    o.preventDefault(), o.stopPropagation(), g = o.originalEvent.touches[0] || o.originalEvent.changedTouches[0], v = t(this).parent(), _ = v.offset(), C = g.pageX - _.left, w = g.pageY - _.top, d.data("horizontalScroll") ? d.mCustomScrollbar("scrollTo", x - C) : d.mCustomScrollbar("scrollTo", B - w)
                }), d.data({bindEvent_content_touch: !0})
            }
        }, scroll: function (o) {
            var a = t(this), l = a.find(".mCSB_dragger"), e = a.find(".mCSB_container");
            a.find(".mCustomScrollBox");
            if (a.data("horizontalScroll")) var n = -l.position().left * a.data("scrollAmount"), r = e.position().left,
                i = Math.round(r - n); else var s = -l.position().top * a.data("scrollAmount"), c = e.position().top,
                d = Math.round(c - s);
            if (t.browser.webkit) var u = (window.outerWidth - 8) / window.innerWidth, h = u < .98 || u > 1.02;
            0 === a.data("scrollInertia") || h ? (o || a.mCustomScrollbar("callbacks", "onScrollStart"), a.data("horizontalScroll") ? e.css("left", n) : e.css("top", s), o || (a.data("whileScrolling") && a.data("whileScrolling_Callback").call(), a.mCustomScrollbar("callbacks", "onScroll")), a.data({mCS_Init: !1})) : (o || a.mCustomScrollbar("callbacks", "onScrollStart"), a.data("horizontalScroll") ? e.stop().animate({left: "-=" + i}, a.data("scrollInertia"), a.data("scrollEasing"), function () {
                o || a.mCustomScrollbar("callbacks", "onScroll"), a.data({mCS_Init: !1})
            }) : e.stop().animate({top: "-=" + d}, a.data("scrollInertia"), a.data("scrollEasing"), function () {
                o || a.mCustomScrollbar("callbacks", "onScroll"), a.data({mCS_Init: !1})
            }))
        }, scrollTo: function (o, a) {
            a = t.extend({moveDragger: !1, callback: !0}, a);
            var l, e, n = t(this), r = n.find(".mCustomScrollBox"), i = r.children(".mCSB_container"),
                s = n.find(".mCSB_draggerContainer"), c = s.children(".mCSB_dragger");
            if (o || 0 === o) {
                if ("number" == typeof o) a.moveDragger ? l = o : (e = o, l = Math.round(e / n.data("scrollAmount"))); else if ("string" == typeof o) {
                    var d;
                    1 === (d = "top" === o ? 0 : "bottom" !== o || n.data("horizontalScroll") ? "left" === o ? 0 : "right" === o && n.data("horizontalScroll") ? i.outerWidth() - r.width() : "first" === o ? n.find(".mCSB_container").find(":first") : "last" === o ? n.find(".mCSB_container").find(":last") : n.find(o) : i.outerHeight() - r.height()).length ? (e = n.data("horizontalScroll") ? d.position().left : d.position().top, l = Math.ceil(e / n.data("scrollAmount"))) : l = d
                }
                l < 0 && (l = 0), n.data("horizontalScroll") ? (l >= s.width() - c.width() && (l = s.width() - c.width()), c.css("left", l)) : (l >= s.height() - c.height() && (l = s.height() - c.height()), c.css("top", l)), a.callback ? n.mCustomScrollbar("scroll", !1) : n.mCustomScrollbar("scroll", !0)
            }
        }, callbacks: function (o) {
            var a = t(this), l = a.find(".mCustomScrollBox"), e = a.find(".mCSB_container");
            switch (o) {
                case"onScrollStart":
                    e.is(":animated") || a.data("onScrollStart_Callback").call();
                    break;
                case"onScroll":
                    if (a.data("horizontalScroll")) {
                        var n = Math.round(e.position().left);
                        n < 0 && n <= l.width() - e.outerWidth() + a.data("onTotalScroll_Offset") ? a.data("onTotalScroll_Callback").call() : n >= -a.data("onTotalScroll_Offset") ? a.data("onTotalScrollBack_Callback").call() : a.data("onScroll_Callback").call()
                    } else {
                        var r = Math.round(e.position().top);
                        r < 0 && r <= l.height() - e.outerHeight() + a.data("onTotalScroll_Offset") ? a.data("onTotalScroll_Callback").call() : r >= -a.data("onTotalScroll_Offset") ? a.data("onTotalScrollBack_Callback").call() : a.data("onScroll_Callback").call()
                    }
                    break;
                case"whileScrolling":
                    a.data("whileScrolling_Callback") && !a.data("whileScrolling") && a.data({
                        whileScrolling: setInterval(function () {
                            e.is(":animated") && !a.data("mCS_Init") && a.data("whileScrolling_Callback").call()
                        }, a.data("whileScrolling_Interval"))
                    })
            }
        }, disable: function (o) {
            var a = t(this), l = a.children(".mCustomScrollBox"), e = l.children(".mCSB_container"),
                n = l.children(".mCSB_scrollTools"), r = n.find(".mCSB_dragger");
            l.unbind("mousewheel focusin"), o && (a.data("horizontalScroll") ? r.add(e).css("left", 0) : r.add(e).css("top", 0)), n.css("display", "none"), e.addClass("mCS_no_scrollbar"), a.data({
                bindEvent_mousewheel: !1,
                bindEvent_focusin: !1
            }).addClass("mCS_disabled")
        }, destroy: function () {
            var o = t(this), a = o.find(".mCSB_container").html();
            o.find(".mCustomScrollBox").remove(), o.html(a).removeClass("mCustomScrollbar _mCS_" + t(document).data("mCustomScrollbar-index")).addClass("mCS_destroyed")
        }
    };
    t.fn.mCustomScrollbar = function (a) {
...
}(jQuery), (iOSVersion = iOSVersion()) >= 6 && function (t) {
    var o = {}, a = {}, l = t.setTimeout, e = t.setInterval, n = t.clearTimeout, r = t.clearInterval;
    if (!t.addEventListener) return !1;

    function i(o, a, l) {
        var n, r = l[0], i = o === e;
        return l[0] = function () {
            r && (r.apply(t, arguments), i || (delete a[n], r = null))
        }, n = o.apply(t, l), a[n] = {args: l, created: Date.now(), cb: r, id: n}, n
    }

    function s(o, a, l, n, r) {
        var i = l[n];
        if (i) {
            var s = o === e;
            if (a(i.id), !s) {
                var c = i.args[1], d = Date.now() - i.created;
                d < 0 && (d = 0), (c -= d) < 0 && (c = 0), i.args[1] = c
            }
            i.args[0] = function () {
                i.cb && (i.cb.apply(t, arguments), s || (delete l[n], i.cb = null))
            }, i.created = Date.now(), i.id = o.apply(t, i.args)
        }
    }
    ...
    for (var c = t; c.location != c.parent.location;) c = c.parent;
    c.addEventListener("scroll", function () {
        var t;
        for (t in o) s(l, n, o, t);
        for (t in a) s(e, r, a, t)
    })
}(window);
